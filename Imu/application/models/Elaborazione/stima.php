            ...
            if ($quote[$chiaveForm2] > 0) { // se l'utente ha messo una quota percentuale calcola la parte
                if ($valoriForm1["area_urbanizzata"] == 1) { // se la zona è urbanizzata
                    ...
                    foreach ($dati_cessione as $dati_cessione_riga) {
                        ...
                        $ret[0][$chiaveForm2] = "id macro ambiti: " . $valoriForm1["id_m_ambiti"] ." id subambiti". $valoriForm1["id_u_sambiti"] . " modalità di intervento id". $valoriForm1["id_u_modinterv"] . " id subdestinazioni" . $valoriForm2["id_u_sdestinazioni"] . " id_u_cessioni " . $id_u_cessioni . " quota cessione: " . $quota_cessione . "<br/>";
                    }

                    // prelevo i dati per la t_stima
                    // prelevo il fattore di conversione standard qualità fcspq
                    ...
                    $ret[4][$chiaveForm2]= "indice capacità edificatoria: " . $indice_capacità_edificatoria;
                    // incidenza viabilità 
                    $tmp = null;
                    ...
                    $ret[5][$chiaveForm2]= "indicenza viabilità: " . $incidenza_viabilità;
                    ...
                    $ret[10][$chiaveForm2] = "fattore incidenza viabilità: " . $fattore_incidenza_viabilità  ."incidenza viabilita: " . $incidenza_viabilità . " indice cap edific: ".                     $fattore_incidenza_viabilità = $incidenza_viabilità / $indice_capacità_edificatoria;

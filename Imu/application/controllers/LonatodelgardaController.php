...
class LonatodelgardaController extends Zend_Controller_Action
{
    ...
    {
        $this->lonato_s_rifunitariedest = Factory_dbTable::getClass("017092", 
                "s_rifunitariedest");
        $this->lonato_s_tstima = Factory_dbTable::getClass("017092", "s_tstima");
        $this->lonato_s_zone = Factory_dbTable::getClass("017092", "s_zone");
        $this->lonato_u_cessioni = Factory_dbTable::getClass("017092", 
                "u_cessioni");
        $this->lonato_u_destammesse = Factory_dbTable::getClass("017092", 
                "u_destammesse");
        $this->lonato_u_mambiti = Factory_dbTable::getClass("017092", 
                "u_mambiti");
        $this->lonato_u_mdestinazioni = Factory_dbTable::getClass("017092", 
                "u_mdestinazioni");
        $this->lonato_u_modinterv = Factory_dbTable::getClass("017092", 
                "u_modinterv");
        $this->lonato_u_sambiti = Factory_dbTable::getClass("017092", 
                "u_sambiti");
        $this->lonato_u_sdestinazioni = Factory_dbTable::getClass("017092", 
                "u_sdestinazioni");
        $this->lonato_log = Factory_dbTable::getClass("017092", "log");
        $this->lonato_var_indici = Factory_dbTable::getClass("017092", 
                "var_indici");
        ...
        if ($request->isPost()) {
            if ($form->isValid($request->getPost())) {
                if ($this->_process_index($form->getValues())) {
                    $urlOptions = array('controller' => 'lonatodelgarda', 
                            'action' => 'selezione-ambiti');
                    // $this->view->notifica = '<style>.notifica{
                    // background-color:green; padding:2px;}</style>Modulo
                    // salvato con successo.';
                    $this->_helper->redirector->gotoRoute($urlOptions);
                } else {
                    // $this->_helper->redirector->gotoRoute($urlOptions,'azioni');
                    // $this->view->notifica = '<span style="padding:2px;">Ops,
                // si è verificato un errore.</span>';
                }
            }
        }
    ...
    protected function _process_anagrafe ($values)
    {
        ...
        $ret = $this->lonato_log->inserisciLog($values['nome'], 
                $values['cognome'], $values['cf']);
        return $ret;
    }
    ...
    protected function _process_lonato_imu ($values)
    {
        ...
        // ottengo gli indici subambiti da mostrare e li metto in sessione
        // (possibile metodo a parte da sviluppare volendo)
        // prendo i dati da mostrare
        $db_row_sambiti = $this->lonato_u_sambiti->getAll(
                $values["id_u_sambiti"], $session->data_calcolo);
        ...
        foreach ($db_row_sambiti as $chiave_sambiti => $valore_sambiti_riga) {
            ...
            // $stampa.='<tr>';
            // $stampa.="<td colspan='3' style='font-weight:bold;
            // font-size:14px;'>Indici sub ambiti:</td></tr>";
            ...
            if (strtolower($tipo_stima[0]) == "v") {
                ...
                $stampa .= "<td>" . $valore_sambiti_riga->indice_fondiario .
                         "</td>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->incremento_lotti_saturi_i .
                                 "</td>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->indice_territoriale .
                                 "</td>";
                        $stampa .= "<td>(volume in m3/m2)</td></tr>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->volume_preesistente .
                                 "</td>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->volume_incremento .
                                 "</td>";
                        $stampa .= "<td>(volume in m3)</td></tr>";
                        // volume predefinito
                        $stampa .= '<tr>';
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->volume_predefinito_d .
                                 "</td>";
                        $stampa .= "<td>(volume in m3)</td></tr>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->indice_fondiario_aggiuntivo .
                                 "</td>";
                        $stampa .= "<td>(volume in m3/m2)</td></tr>";
                        // chiudo la tabella
                        $stampa .= '</table>';
                        // salvo in sessioni
                        $session->indici_u_sambiti_txt = array(
                                "testo1" => "Indice fondiario", 
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->utilizzazione_fondiaria .
                                 "</td>";
                        ...
                        $stampa .= "<td>Incremento lotti saturi</td>";
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->incremento_lotti_saturi_u .
                                 "</td>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->utilizzazione_territoriale .
                                 "</td>";
                        $stampa .= "<td>(slp in m2slp/m2)</td></tr>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->utilizzazione_preesistente .
                                 "</td>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->utilizzazione_incremento .
                                 "</td>";
                        $stampa .= "<td>(slp in m2slp)</td></tr>";
                        ...
                        $stampa .= "<td>" .
                                 $valore_sambiti_riga->utilizzazione_predefinita_d .
                                 "</td>";
                        $stampa .= "<td>(slp in m2slp)</td></tr>";
                        // chiudo la tabella
                        $stampa .= '</table>';
                        // salvo in sessioni
                        $session->indici_u_sambiti_txt = array(
                                "testo1" => "Indice utilizzazione fondiaria", 
                        ...
                        throw new Exception(
                                "Errore in process_lonato_imu: tipo stima non valida: " .
                                         $tipo_stima);
                    }
                }
                // salvo in sessione
                ...
                // ottengo la dbtable
                $db_row_mambiti = $this->lonato_u_mambiti->getAll(
                        $values["id_m_ambiti"], $session->data_calcolo);
                $stampa = "";
                foreach ($db_row_mambiti as $chiave_mambiti => $valore_mambiti_riga) {
                    ...
                    // $stampa.='<tr>';
                    // $stampa.="<td colspan='3' style='font-weight:bold;
                    // font-size:14px;'>Indici macro ambiti:</td></tr>";
                    ...
                    $stampa .= "<td>" .
                             $valore_mambiti_riga->valore_comprensativo_unitario .
                             "</td>";
                    ...
                    $stampa .= "<td>" . $contributo_compensativo_aggiuntivo .
                             "</td>";
                            $stampa .= "<td></td>";
                            ...
                            $valore_ambiti_riga = (($valore_mambiti_riga->standard_pubblico_qualita) *
                                     100);
                                    $stampa .= "<td>" . $valore_ambiti_riga .
                                             " %" . "</td>";
                                            $stampa .= "<td>mqSlp</td>";
                                            // chiudo la tabella
                                            $stampa .= '</table>';
                                        ...
                                        $session->indici_mambiti_stampa_txt = array(
                                                "valore_comprensativo_unitario" => $valore_comprensativo_unitario, 
                                                "contributo_compensativo_aggiuntivo" => $contributo_compensativo_aggiuntivo, 
                                                "standard_pubblico_qualita" => $standard_pubblico_qualita);
                                        
                                        // ottengo i dati riassuntivi form
                                        // precedente
                                        // query al db per ottenere i dati dai
                                        // mostrare
                                        // nome macro ambito
                                        $nome_macro_ambito_rowset = $this->lonato_u_mambiti->getAll(
                                                $values["id_m_ambiti"], 
                                                $session->data_calcolo);
                                        foreach ($nome_macro_ambito_rowset as $chiave => $valore) {
                                            $nome_macro_ambito = $valore->descrizione;
                                        }
                                        // nome sub ambito
                                        $nome_sub_ambito_rowset = $this->lonato_u_sambiti->getAll(
                                                $values["id_u_sambiti"], 
                                                $session->data_calcolo);
                                        ...
                                        // nome zona
                                        $nome_zona_rowset = $this->lonato_s_zone->getAll(
                                                $values["id_s_zone"], 
                                                $session->data_calcolo);
                                        ...
                                        $modalita_intervento_rowset = $this->lonato_u_modinterv->getAll(
                                                $values["id_u_modinterv"]);
                                        ...
                                        // font-size:14px;'>Dati scelti in
                                        // precedenza:</td></tr>";
                                        // macro ambito
                                        $stampa .= '<tr class="header-tabella1">';
                                        $stampa .= "<td>Macro ambito</td>";
                                        $stampa .= "<td>" . $nome_macro_ambito .
                                                 "</td>";
                                                // sub ambito
                                                $stampa .= '<tr>';
                                                ...
                                                $stampa .= "<td>" . $nome_zona .
                                                        ...
                                                        $stampa .= "<td>";
                                                        $area_urbanizzata = ($values["area_urbanizzata"] ==
                                                                 1) ? "Si" : "No";
                                                                $stampa .= $area_urbanizzata;
                                                                $stampa .= "</td>";
                                                                $lotto_saturo = ($values["lotto_saturo"] ==
                                                                         1) ? "Si" : "No";
                                                                        if ($values["area_urbanizzata"] ==
                                                                                 1) {
                                                                                    // lotto
                                                                                    // saturo:
                                                                                    // solo
                                                                                ...
                                                                                // intervento
                                                                                $stampa .= '<tr ';
                                                                                $stampa .= ($values["area_urbanizzata"] ==
                                                                                         1) ? "" : "class='header-tabella1'";
                                                                                        $stampa .= '>';
                                                                                        ...
                                                                                        $stampa .= ($values["area_urbanizzata"] ==
                                                                                                 1) ? "class='header-tabella1'" : "";
                                                                                                $stampa .= '>';
                                                                                                $tmptxtsup = ($values["area_urbanizzata"] ==
                                                                                                         1) ? "Superficie Fondiaria  (m2)" : "Superficie Territoriale (m2)";
                                                                                                        $stampa .= "<td>" .
                                                                                                                 $tmptxtsup .
                                                                                                                 "</td>";
                                                                                                        $stampa .= "<td>" .
                                                                                                        ...
                                                                                                        if (strtolower(
                                                                                                            ...
                                                                                                            $stampa .= ($values["area_urbanizzata"] ==
                                                                                                                ...
                                                                                                                // per
                                                                                                                // stampa
                                                                                                                $session->riassunto_step1_txt = array(
                                                                                                                        "nome_macro_ambito" => $nome_macro_ambito, 
                                                                                                            ...
                                                                                                            public function stimaAction ()
                                                                                                            {
                                                                                                                ...
                                                                                                                require_once APPLICATION_PATH .
                                                                                                                         "/models/Elaborazione/stima.php";
                                                                                                                        $session->capacita_edificatoria = Stima::calcolaCapacitaEdificatoriaLonato();
                                                                                                                        
                                                                                                                        $this->view->capacita_edificatoria = $session->capacita_edificatoria;
                                                                                                                        
                                                                                                                        $form = new Application_Form_Lonatodelgardastep2(
                                                                                                                                array(
                                                                                                                        ...
                                                                                                                        if ($request->isPost()) {
                                                                                                                            if ($form->isValid(
                                                                                                                                ...
                                                                                                                                if ($this->_process_lonato_imu_step2(
                                                                                                                                        $form->getValues())) {
                                                                                                                                    $urlOptions = array(
                                                                                                                                            'controller' => 'Lonatodelgarda', 
                                                                                                                                            'action' => 'anagrafe');
                                                                                                                                    $this->view->notifica = '<style>.notifica{ background-color:green; padding:2px;}</style>Modulo salvato con successo.';
                                                                                                                    ...
                                                                                                                    protected function _process_lonato_imu_step2 (
                                                                                                                            $valori)
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        require_once APPLICATION_PATH .
                                                                                                                                ...
                                                                                                                                // stima
                                                                                                                                // unitaria
                                                                                                                                $session->stimaUnitaria = Stima::calcolaStimaSingolaLonato(
                                                                                                                                        $percentualeQuote);
                                                                                                                                // calcolo
                                                                                                                                // valore
                                                                                                                                // area
                                                                                                                                ...
                                                                                                                                // semplice
                                                                                                                                // moltiplicazione
                                                                                                                                $session->valoreAreaEdificabile = 0; // $session->stimaUnitaria
                                                                                                                                                                     // *
                                                                                                                                                                     // $session->capacita_edificatoria;
                                                                                                                                return true; // non
                                                                                                                                             // ho
                                                                                                                                             // incontrato
                                                                                                                                             // errori
